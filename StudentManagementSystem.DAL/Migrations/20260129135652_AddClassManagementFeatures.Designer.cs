...
namespace StudentManagementSystem.DAL.Migrations
{
    ...
    [Migration("20260129135652_AddClassManagementFeatures")]
    partial class AddClassManagementFeatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentManagementSystem.DAL.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            PasswordHash = "$2a$11$VIyNc4Iwowtc5bU9WDr3qekUJwvHp6DMt80V/b.g0C8AMyIrGlmGG",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
