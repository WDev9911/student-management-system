...
namespace StudentManagementSystem.DAL.Migrations
{
    ...
    [Migration("20260129104826_AddDepartmentToInstructor")]
    partial class AddDepartmentToInstructor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentManagementSystem.DAL.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            PasswordHash = "$2a$11$a2b3NHxJgiXMVhSvM6U8zuMG6doXeprrvilrnWfIXNrmaXfYmceNS",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
