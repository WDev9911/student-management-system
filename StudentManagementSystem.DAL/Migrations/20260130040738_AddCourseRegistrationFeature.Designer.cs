...
namespace StudentManagementSystem.DAL.Migrations
{
    ...
    [Migration("20260130040738_AddCourseRegistrationFeature")]
    partial class AddCourseRegistrationFeature
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentManagementSystem.DAL.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            PasswordHash = "$2a$11$tmJQN3Rws6ufSojY2biFs.HD8yf5M0g0eelI7hCTzgHgCgIrXFZge",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
